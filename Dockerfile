...
ENV PYTHONDONTWRITEBYTECODE=1 PYTHONUNBUFFERED=1 PIP_NO_CACHE_DIR=1 PORT=8501 RERANKER_MODEL=${RERANKER_MODEL} GROUNDING_MODEL=${GROUNDING_MODEL} GROUNDING_MODEL_REVISION=${GROUNDING_MODEL_REVISION}
WORKDIR /app
